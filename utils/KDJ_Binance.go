...
func NewKdj_Binance(period int) *KDJ_Binance {
	_kdj := &KDJ_Binance{Period: 9, RSV: make([]float64, 0), K: make([]float64, 0), D: make([]float64, 0), J: make([]float64, 0)}
	return _kdj
}
...
*/
func (_kdj *KDJ_Binance) CalculationKDJ(records []info.BinanceKline_DB) {
 ...
 */
func (_kdj *KDJ_Binance) calculationKD(records []info.BinanceKline_DB) {
 ...
 * @return {[type]}      [description]
 */
func (_kdj *KDJ_Binance) CalculationJ() {
	length := len(_kdj.K)
...
func (_kdj *KDJ_Binance) highest(Price []float64, periods int) []float64 {
...
func (_kdj *KDJ_Binance) lowest(Price []float64, periods int) []float64 {
	var periodArr []float64
	length := len(Price)
...
func (_kdj *KDJ_Binance) arrayLowest(Price []float64) float64 {
	length := len(Price)
	var lowest = Price[0]
...
func (_kdj *KDJ_Binance) arrayHighest(Price []float64) float64 {
	length := len(Price)
	var highest = Price[0]
