...
func NewKdj_Huobi(period int) *KDJ_Huobi {
	_kdj := &KDJ_Huobi{Period: 9, RSV: make([]float64, 0), K: make([]float64, 0), D: make([]float64, 0), J: make([]float64, 0)}
	return _kdj
}
...
*/
func (_kdj *KDJ_Huobi) CalculationKDJ(records []info.HuobiKline_DB) {
 ...
 */
func (_kdj *KDJ_Huobi) calculationKD(records []info.HuobiKline_DB) {
 ...
 * @return {[type]}      [description]
 */
func (_kdj *KDJ_Huobi) CalculationJ() {
	length := len(_kdj.K)
...
func (_kdj *KDJ_Huobi) highest(Price []float64, periods int) []float64 {
...
func (_kdj *KDJ_Huobi) lowest(Price []float64, periods int) []float64 {
	var periodArr []float64
	length := len(Price)
...
func (_kdj *KDJ_Huobi) arrayLowest(Price []float64) float64 {
	length := len(Price)
	var lowest = Price[0]
...
func (_kdj *KDJ_Huobi) arrayHighest(Price []float64) float64 {
	length := len(Price)
	var highest = Price[0]
